...
func (Executor) Run(ctx context.Context, step venom.TestStep) (interface{}, error) {
	...
	if err := checkMethods(e.Method); err != nil {
		return nil, err
	}
...
func checkMethods(method string) error {
	switch method {
	case "get":
		return nil
	case "create":
	...
	case "version":
		return nil
	default:
		return fmt.Errorf("Method not supported, allowed (get|create|delete|version) not: " + method)
	}
}
